<header class="sticky top-0 border-gray-200 drop-shadow-lg backdrop-blur-sm sm:py-3 z-20 " style="background-color: #05779170;">
    <nav x-data="{ isOpen: false }">
      <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
          <div  class="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <!-- Mobile menu button-->
            <button type="button" @click="isOpen = !isOpen" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex shrink-0 items-center">
              <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <table class="w-52 font-semibold">
                  <th>
                  <td>
                    <h1 class="text-3xl">ARKAT</h1>
                  </td>
                  <td class="text-xs ">
                    <li type="none">BUY & SELL</li>
                    <li type="none">CAR</li>
                  </td>
                  </th>
                </table>
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-6 text-md font-semibold tracking-widest text-slate-100 ">
      ...
      <div x-show="isOpen" class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 text-sm font-semibold tracking-widest text-slate-100">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:text-white" -->
